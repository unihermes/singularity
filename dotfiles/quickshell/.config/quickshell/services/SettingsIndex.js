...
var entries = [
    ...
    { page: "appearance", section: "Look",  label: "Modules",           keywords: "bar chips" },
    { page: "appearance", section: "Look",  label: "Bar",               keywords: "floating islands notch bare" },
    { page: "appearance", section: "Look",  label: "Workspaces",        keywords: "indicator dots" },
    { page: "appearance", section: "Look",  label: "Clock",             keywords: "time date" },
    { page: "appearance", section: "Look",  label: "Frames",            keywords: "stroke bevel double" },
    { page: "appearance", section: "Look",  label: "Stroke width",      keywords: "border outline line thickness px" },
    { page: "appearance", section: "Look",  label: "Density",           keywords: "spacing padding compact" },
    { page: "appearance", section: "Look",  label: "Headings",          keywords: "titles caps uppercase bold rule" },
    { page: "appearance", section: "Look",  label: "Font",              keywords: "typeface family monospace shell bar" },
    { page: "appearance", section: "Look",  label: "System font",       keywords: "typeface family gtk qt apps interface ui" },
